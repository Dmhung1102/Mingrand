...
<body>
                ...
                <div class="container">
                    <div class="banner-inner">
                        <div class="section-tittle text-center">
                            <h2 class="page-tittle">Proparty Grid</h2>
                            <ul class="page-list">
                                <a href="./index.html">
                                    <li>Home ></li>
                                </a>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-12 mt-5">
                                        <div class="single-propartes">
                                            <a href="./proparty_details.html"><img src="./assets/img/proparty-details/png7.jpg" alt=""></a>
                                            <div class="propartes-img">
                                                <div class="media pb-3 px-3">
                                                    <div class="author justify-content-around">
                                                        ...
                                                        <a class="">Compare</a>
                                                        <span>|</span>
                                                        <a href="./proparty_details.html">Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="propartes-wrap-details p-xl-2 p-4">
                                                <h4>
                                                    <a href="./proparty_details.html">Daily Apartment</a>
                                                </h4>
                                    ...
                                    <div class="col-xl-6 col-12 mt-5">
                                        <div class="single-propartes">
                                            <div class="propartes-img">
                                                <img src="./assets/img/proparty-details/png10.png" alt="">
                                                <div class="media pb-3 px-3">
                                                    <div class="author justify-content-around">
                    ...
                    <div class="col-lg-4 px-xl-5">
                        ...
                        <div class="price-area mt-5">
                            <div class="newfeed-categories pt-3">
                                ...
                                <div class="popular-feed-inner border-bottom">
                                ...
                                <div class="popular-feed-inner mt-2 pb-0">
                                    <div class="thumbnail mt-2 ">
                                        <img src="./assets/img/rv-png-1.png" alt="">
                                    </div>
                                    <div class="details mt-2">
    ...
    <script>
        var tabLinks = document.querySelectorAll(".tablinkss");
        var tabContent = document.querySelectorAll(".tabcontentt");
